  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        "inset-x-0 bottom-0 rounded-t-lg max-h-[90vh] overflow-y-auto",
        "sm:left-[50%] sm:top-[50%] sm:bottom-auto sm:inset-x-auto sm:max-w-lg sm:translate-x-[-50%] sm:translate-y-[-50%] sm:rounded-lg",
        className,
      )}
      {...props}
    >
